...
export class ZoneRoom extends Room<ZoneState> {
  ...
  onCreate(): void {
    ...
    this.creatures = new CreatureManager(this.world, this.state);
    this.creatures.spawn(6);
  ...
  private tick(): void {
    ...
    // Step the husks with the same physics, right after players.
    this.creatures.tick(TICK_MS / 1000);
  }
