/**
 * Module 08D — same controller as Module 08, but edits now go through a single
 * `edit(x,y,z,b)` callback (wired to WorldManager) instead of mutating the world
 * and rebuilding everything. WorldManager re-meshes only the affected chunk, in
 * the worker.
 */
